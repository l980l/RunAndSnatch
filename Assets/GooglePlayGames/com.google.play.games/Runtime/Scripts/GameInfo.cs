...
namespace GooglePlayGames {
    ...
    public static class GameInfo {
        ...
        public const string ApplicationId = "000000000000"; // Filled in automatically
        public const string IosClientId = "__IOS_CLIENTID__"; // Filled in automatically
        public const string WebClientId = "000000000000-YOUR_CLIENT_ID.apps.googleusercontent.com"; // Filled in automatically
